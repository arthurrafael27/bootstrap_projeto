    ...
    <div class="box">
        ...
        <div class="container chamada-banner">
          <div class="row">
              <div class="col-md-12 text-center">
                  <h2><?php echo htmlentities(''); ?>TALKS<?php echo htmlentities('');  ?></h2>
                  <p>Empresa voltada para desenvolvimento da oratória</p>
                  <a href="">Saiba Mais!</a>
              </div><!--col-md-12-->
          </div><!--row-->
        </div>
      ...
      <section class="depoimento text-center">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                  <h2>Depoimento dos nossos colaboradores!</h2>
                    <blockquote>
      ...
      <section class="final-site">
          <div class="container">
              <div class="row">
                  ...
                  <div class="col-md-6">
                      <h2>Nossos planos de cursos para oratória</h2>
                        <table class="table">
                            <thead>
                              <tr>
                                <th>Plano Semanal</th>
